...
// ////////////////////////////////////////////////
        ...
        return view("back.dashboard.tenant",['jobsState_count'=>$jobsState_count, 'jobs_count' => $jobs_count,'countApplcatnt'=>$countApplcatnt, 'job_depertments'=>$job_depertments,'jobApplicant'=>$jobApplicant ,'categoryCount'=>$categoryCount]); 
    }
}
